...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self getData];
    [self.tableView registerNib:[UINib nibWithNibName:@"CentreTableViewCell" bundle:nil] forCellReuseIdentifier:@"centreCell"];
}
...
{
    CentreTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"centreCell" forIndexPath:indexPath];
